...
public class StartSub implements SubCommand {
    ...
    public StartSub(MessageService messages, kr.ssapi.services.ApiClient apiClient, kr.ssapi.services.ApiErrorMapper errorMapper, boolean adminMode) {
    ...
    public ExecutionResult execute(CommandSender sender, String[] args) {
        ...
        StorageManager.getDriver().setEnabled(target.getUniqueId().toString(), true);
